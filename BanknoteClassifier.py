...
class BanknoteClassifier:
    ...
    def __init__(self, dataset):
        ...
        scaled_features_matrix = StandardScaler().fit_transform(
            features_matrix)  # scale the data so mean = 0, unit variance - important for many models
        ...
        self.training_features, self.test_features, self.training_class, self.test_class = train_test_split(
            scaled_features_matrix, targets, test_size=0.20, random_state=21)
