...
We found that elbow points in drops of accuracy existed for most classifiers as we increased the percentage of the data points allocated towards the test set. The green dots below show performance on the training set, and the red dots show performance on the test set.
\begin{figure}
\centering
